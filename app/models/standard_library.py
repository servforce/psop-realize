...
from app.models.entities import (
    CallLog as WorkbenchCallLog,
    VideoFrame as WorkbenchVideoFrame,
    VideoJob as WorkbenchVideoJob,
    WireframeJob as WorkbenchWireframeJob,
)
...
class VideoJob(StandardLibraryBase):
    __table__ = WorkbenchVideoJob.__table__.to_metadata(StandardLibraryBase.metadata)


class VideoFrame(StandardLibraryBase):
    __table__ = WorkbenchVideoFrame.__table__.to_metadata(StandardLibraryBase.metadata)


class WireframeJob(StandardLibraryBase):
    __table__ = WorkbenchWireframeJob.__table__.to_metadata(StandardLibraryBase.metadata)


class CallLog(StandardLibraryBase):
    __table__ = WorkbenchCallLog.__table__.to_metadata(StandardLibraryBase.metadata)
